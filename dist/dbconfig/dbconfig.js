...
var execQuery = function (query) { return __awaiter(void 0, void 0, void 0, function () {
    var client, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                client = _a.sent();
                return [4 /*yield*/, client.query(query).catch(function (err) {
                        console.log(err);
                    })];
            case 2:
                res = _a.sent();
...
process.on("exit", function () { return pool.end(); });
